...
CoTryTask<GetUploadJobRsp> MetaOperator::getUploadJob(GetUploadJobReq req) {
  AUTHENTICATE(req.user);
  CO_RETURN_ON_ERROR(req.valid());
  CO_RETURN_ON_ERROR(checkCachePhase4(req.cacheProtocolVersion));
...
META_PHASE3_METHOD(trackPrefetchReady, TrackPrefetchReadyReq, TrackPrefetchReadyRsp);
META_PHASE3_METHOD(advancePrefetchJobState, AdvancePrefetchJobStateReq, AdvancePrefetchJobStateRsp);
META_PHASE3_METHOD(cancelPrefetchJob, CancelPrefetchJobReq, CancelPrefetchJobRsp);
