...
DEFINE_PREFIX(CacheBlockState,  "CBST")
DEFINE_PREFIX(CacheMigration,   "CMIG")
...
DEFINE_PREFIX(PinOwnerLease,    "PNOL")
DEFINE_PREFIX(UploadJob,        "UPJB")
DEFINE_PREFIX(UploadActiveJob,  "UPAJ")
DEFINE_PREFIX(UploadOpenLease,  "UPOL")
DEFINE_PREFIX(UploadStateJob,   "UPSJ")
DEFINE_PREFIX(UploadMigration,  "UPMG")
