...
CACHE_STATUS(RequestTooLarge, 12007)
CACHE_STATUS(NotFound, 12008)
CACHE_STATUS(AccessDenied, 12009)
CACHE_STATUS(Throttled, 12010)
CACHE_STATUS(Timeout, 12011)
CACHE_STATUS(Unavailable, 12012)
CACHE_STATUS(InvalidResponse, 12013)
CACHE_STATUS(GenerationAdvanced, 12014)
CACHE_STATUS(RoleMismatch, 12015)
CACHE_STATUS(PermitExpired, 12016)
CACHE_STATUS(PermitConflict, 12017)
CACHE_STATUS(PlacementMismatch, 12018)
CACHE_STATUS(EventGap, 12019)
CACHE_STATUS(JournalFull, 12020)
