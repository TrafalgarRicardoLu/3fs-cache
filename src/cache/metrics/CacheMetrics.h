...
enum class Event : uint8_t {
  ...
  MANAGER_RECONCILE_RUN,
  MANAGER_RECONCILE_SCANNED,
  MANAGER_RECONCILE_ORPHAN,
  MANAGER_RECONCILE_MISSING,
  MANAGER_RECONCILE_CONFLICT,
  MANAGER_RECONCILE_REPAIRED,
